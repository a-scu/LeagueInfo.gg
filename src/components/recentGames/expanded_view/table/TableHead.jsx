...
export default function TableHead({
  ...
  return (
    ...
    >
      ...
      <tr className="flex items-center justify-between w-full h-6 px-1 text-center bg-main-1 dark:bg-main-2 max-sm:h-6 text-lg-500 dark:text-dg-500 text-3xs sm:text-2xs">
