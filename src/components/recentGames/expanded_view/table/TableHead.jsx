...
export default function TableHead({
  ...
  return (
    <thead
      className={`max-[0px]:hidden flex w-full flex-col items-center bg-main-4 gap-px`}
    >
      {/* <tr className="flex items-center justify-between w-full h-6 px-1 bg-main-1 dark:bg-main-2 max-sm:h-6 text-2xs max-sm:text-3xs">
        <th className="flex gap-2 p-0 font-normal text-main-6">
        ...
        <th>
          <KillsAndGold
            ...
            summonerTeamGold={team.gold}
            summonerTeamWin={team.win}
            summonerTeamKills={team.kills}
      ...
      <tr className="flex items-center justify-between w-full h-6 px-1 text-center bg-main-1 dark:bg-main-1 max-sm:h-6 text-lg-500 dark:text-dg-500 text-3xs sm:text-2xs">
