export default function GameInfo({ win, queue, gameDuration, gameAge }) {
  return (
    <div
      className={`truncate gap-2 py-1.5 max-800:border-b 800:py-1.5 items-center 800:items-start p-2 max-sm:pr-[46px] pr-12 800:px-0 left-0 max-800:pl-2.5 pl-4 800:static w-full justify-between absolute top-0 flex-row flex 800:flex-col 800:w-28 800:h-full text-2xs 800:text-xs dark:text-dg-500 text-lg-500 ${
        win
