...
const GamesStats = ({ stats }) => {
  ...
  return (
    <div className="max-360:grid-cols-[100px,40px,100px] max-500:grid-cols-[100px,102px,100px] grid-cols-[160px,112px,160px] max-1126:justify-between max-800:rounded-none grid gap-2 max-1126:p-2 overflow-hidden rounded 1126:grid-cols-[1fr,112px] 1126:grid-rows-[fit,fit] bg-main-1">
