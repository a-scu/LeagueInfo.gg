  ...
  if (!data)
    return (
      <div className="flex flex-col items-center flex-1 gap-1 p-2 bg-main-1">
        <span className="text-xs max-500:text-2xs text-main-5">{queue}</span>

        <div className="flex flex-col items-center w-full gap-1">
          <div className="border-4 rounded-full size-16 max-500:size-14 aspect-square bg-main-3 border-main-2" />

          <div className="flex flex-col items-center">
            <span className="text-sm max-500:text-xs text-main-5">
              Unranked
            </span>

            <div className="flex flex-col items-center gap-px text-xs text-center max-500:text-2xs text-main-5">
              <span>···</span>
              <span>···</span>
            </div>
          </div>
